        ...
        <div class="col-lg-7" >
          <div class="p-5">
            <div class="text-center">
              <h1 class="h4 text-gray-900 mb-4">UBAH KONDISI MATERIAL</h1>
            </div>
            <form class="user" action="{{url('/kondisi_material/update', $cek->id )}}" method="POST" enctype="multipart/form-data">
              @csrf            

            <!--   <?php $hari =  date('Y-m-d');?>

              <div class="form-group">
                <input type="date" value="{{$cek->tanggal}}"  required class="form-control form-control-user"name="tanggal" id="tanggale" placeholder="Tanggal Cek" max="<?php echo $hari;?>" min="<?php echo $hari;?>">
              </div> -->
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="number" value="{{$cek->jumlah}}" required class="form-control form-control-user"name="jumlah" id="jumlahe" placeholder="Jumlah">
              </div>
            <div class="form-group">
              <input type="text" value="{{$cek->keterangan}}" required class="form-control form-control-user"name="keterangan" id="exampleInputEmail" placeholder="Keterangan">
            </div>
       <div class="form-group">
