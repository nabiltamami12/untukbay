...
$title = 'Cek Kondisi Trafo';?>
 <title>
   <?php echo $title;?>
       ...
       <br>
             <input style="text-transform: uppercase;font-weight: 900;font-family:serif;" type="text"  disabled readonly="true" class="form-control " placeholder="<?php echo $title; ?>
          ">
           <!--  ---------------Popup Modal--------------- -->
...
<!-- <div class="modal fade" id="exampleModaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> -->
  ...
  font-family:serif;
                ...
                <form action="{{url('/ceklis/store' )}}" method="POST">
                 ...
                 @foreach($nama_material as $key => $cek_data)
                 <tr>
...
onclick="document.getElementById('jumlah1').disabled = false; document.getElementById('keterangan1').disabled = false;"
 ...
 <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah1" name="jumlah1" disabled="disabled" >

                        
                         <textarea  type="text"  required  id="keterangan1" placeholder="keterangan"   name="keterangan1" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah2').disabled = false;document.getElementById('keterangan2').disabled = false;"
                        ...
                        buruk
                         <input  placeholder="
{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah2" name="jumlah2" disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan2"  placeholder="keterangan"   name="keterangan2" disabled="disabled" ></textarea>                   </label>
                    </div>
...
onclick="document.getElementById('jumlah3').disabled = false;document.getElementById('keterangan3').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah3" name="jumlah3" disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan3"  placeholder="keterangan"  name="keterangan3" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah4').disabled = false;document.getElementById('keterangan4').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah4" name="jumlah4" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan4"  placeholder="keterangan"  name="keterangan4" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah5').disabled = false;document.getElementById('keterangan5').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah5" name="jumlah5"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan5"  placeholder="keterangan"  name="keterangan5" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah6').disabled = false;document.getElementById('keterangan6').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah6" name="jumlah6" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan6"  placeholder="keterangan"  name="keterangan6" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah7').disabled = false;document.getElementById('keterangan7').disabled = false;"
                         >
                        buruk
                           <input  type="number" placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required id="jumlah7"  name="jumlah7" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan7"  placeholder="keterangan"  name="keterangan7" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah8').disabled = false;document.getElementById('keterangan8').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah8" name="jumlah8"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan8"  placeholder="keterangan"  name="keterangan8" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah9').disabled = false;document.getElementById('keterangan9').disabled = false"     >
                        buruk
                           <input  type="number" placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required id="jumlah9"  name="jumlah9" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan9"  placeholder="keterangan"  name="keterangan9" disabled="disabled" ></textarea>                    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah10').disabled = false;document.getElementById('keterangan10').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah10" name="jumlah10"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan10" placeholder="keterangan"   name="keterangan10" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah11').disabled = false;document.getElementById('keterangan11').disabled = false;"
                         >
                        buruk
                           <input  type="number" placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required id="jumlah11"  name="jumlah11" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan11" placeholder="keterangan"   name="keterangan11" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah12').disabled = false;document.getElementById('keterangan12').disabled = false;"
                         >
                        buruk
                           <input  type="number" placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required id="jumlah12"  name="jumlah12" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan12" placeholder="keterangan"   name="keterangan12" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah13').disabled = false;document.getElementById('keterangan13').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah13" name="jumlah13" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan13" placeholder="keterangan"   name="keterangan13" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah14').disabled = false;document.getElementById('keterangan14').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah14" name="jumlah14" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan14" placeholder="keterangan"   name="keterangan14" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah15').disabled = false;document.getElementById('keterangan15').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah15" name="jumlah15" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan15" placeholder="keterangan"   name="keterangan15" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah16').disabled = false;document.getElementById('keterangan16').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah16" name="jumlah16" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan16" placeholder="keterangan"   name="keterangan16" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah17').disabled = false;document.getElementById('keterangan17').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah17" name="jumlah17" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan17" placeholder="keterangan"   name="keterangan17" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah18').disabled = false;document.getElementById('keterangan18').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah18" name="jumlah18" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan18" placeholder="keterangan"   name="keterangan18" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah19').disabled = false;document.getElementById('keterangan19').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah19" name="jumlah19" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan19" placeholder="keterangan"   name="keterangan19" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah20').disabled = false;document.getElementById('keterangan20').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah20" name="jumlah20" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan20" placeholder="keterangan"   name="keterangan20" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah21').disabled = false;document.getElementById('keterangan21').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah21" name="jumlah21"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan21" placeholder="keterangan"   name="keterangan21" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah22').disabled = false;document.getElementById('keterangan22').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah22" name="jumlah22" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan22" placeholder="keterangan"   name="keterangan22" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah23').disabled = false;document.getElementById('keterangan23').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah23" name="jumlah23" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan23" placeholder="keterangan"   name="keterangan23" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah24').disabled = false;document.getElementById('keterangan24').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah24" name="jumlah24"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan24" placeholder="keterangan"   name="keterangan24" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah25').disabled = false;document.getElementById('keterangan25').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah25" name="jumlah25" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan25" placeholder="keterangan"   name="keterangan25" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah26').disabled = false;document.getElementById('keterangan26').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah26" name="jumlah26" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan26" placeholder="keterangan"   name="keterangan26" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah27').disabled = false;document.getElementById('keterangan27').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah27" name="jumlah27" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan27" placeholder="keterangan"   name="keterangan27" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah28').disabled = false;document.getElementById('keterangan28').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah28" name="jumlah28" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan28" placeholder="keterangan"   name="keterangan28" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah29').disabled = false;document.getElementById('keterangan29').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah29" name="jumlah29" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan29" placeholder="keterangan"   name="keterangan29" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah30').disabled = false;document.getElementById('keterangan30').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah30" name="jumlah30" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan30" placeholder="keterangan"   name="keterangan30" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah31').disabled = false; document.getElementById('keterangan31').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah31" name="jumlah31" disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan31" placeholder="keterangan"   name="keterangan31" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah32').disabled = false;document.getElementById('keterangan32').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah32" name="jumlah32" disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan32" placeholder="keterangan"   name="keterangan32" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah33').disabled = false;document.getElementById('keterangan33').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah33" name="jumlah33" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan33" placeholder="keterangan"   name="keterangan33" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah34').disabled = false;document.getElementById('keterangan34').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number" id="jumlah34"  name="jumlah34" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan34" placeholder="keterangan"   name="keterangan34" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah53').disabled = false;document.getElementById('keterangan53').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah53" name="jumlah53"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan53" placeholder="keterangan"   name="keterangan53" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah35').disabled = false;document.getElementById('keterangan35').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah35" name="jumlah35"disabled="disabled" >
                         <textarea  type="text"  required  id="keterangan35" placeholder="keterangan"   name="keterangan35" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah36').disabled = false;document.getElementById('keterangan36').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number" id="jumlah36"  name="jumlah36" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan36" placeholder="keterangan"   name="keterangan36" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah37').disabled = false;document.getElementById('keterangan37').disabled = false;"
                         >
                        buruk
                           <input placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah37"  name="jumlah37" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan37" placeholder="keterangan"   name="keterangan37" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah38').disabled = false;document.getElementById('keterangan38').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah38" name="jumlah38" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan38" placeholder="keterangan"   name="keterangan38" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah39').disabled = false;document.getElementById('keterangan39').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah39" name="jumlah39" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan39" placeholder="keterangan"   name="keterangan39" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah40').disabled = false;document.getElementById('keterangan40').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah40" name="jumlah40" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan40" placeholder="keterangan"   name="keterangan40" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah41').disabled = false;document.getElementById('keterangan41').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah41" name="jumlah41" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan41" placeholder="keterangan"   name="keterangan41" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah42').disabled = false;document.getElementById('keterangan42').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah42" name="jumlah42" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan42" placeholder="keterangan"   name="keterangan42" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah43').disabled = false;document.getElementById('keterangan43').disabled = false;"
                         >
                        buruk
                           <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah43" name="jumlah43" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan43" placeholder="keterangan"   name="keterangan43" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah44').disabled = false;document.getElementById('keterangan44').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah44" name="jumlah44" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan44" placeholder="keterangan"   name="keterangan44" disabled="disabled" ></textarea>    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah45').disabled = false;document.getElementById('keterangan45').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah45" name="jumlah45" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan45" placeholder="keterangan"   name="keterangan45" disabled="disabled" ></textarea>    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah46').disabled = false;document.getElementById('keterangan46').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah46" name="jumlah46" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan46" placeholder="keterangan"   name="keterangan46" disabled="disabled" ></textarea>    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah47').disabled = false;document.getElementById('keterangan47').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah47" name="jumlah47" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan47" placeholder="keterangan"   name="keterangan47" disabled="disabled" ></textarea>    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah48').disabled = false;document.getElementById('keterangan48').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah48" name="jumlah48" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan48" placeholder="keterangan"   name="keterangan48" disabled="disabled" ></textarea>    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah49').disabled = false;document.getElementById('keterangan49').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah49" name="jumlah49" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan49" placeholder="keterangan"   name="keterangan49" disabled="disabled" ></textarea>    
                      </label>
                    </div>
</td>
...
onclick="document.getElementById('jumlah50').disabled = false;document.getElementById('keterangan50').disabled = false;"
                         >
                        buruk
                        <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah50" name="jumlah50" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan50" placeholder="keterangan"   name="keterangan50" disabled="disabled" ></textarea>    
                      </label>
                    </div>
...
onclick="document.getElementById('jumlah51').disabled = false;document.getElementById('keterangan51').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah51" name="jumlah51" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan51" placeholder="keterangan"   name="keterangan51" disabled="disabled" ></textarea>
...
onclick="document.getElementById('jumlah52').disabled = false;document.getElementById('keterangan52').disabled = false;"
                         >
                        buruk
                         <input  placeholder="{{$jumlah_pinjam}}" min="0" max="{{$jumlah_pinjam}}" required type="number"  id="jumlah52" name="jumlah52" disabled="disabled">
                         <textarea  type="text"  required  id="keterangan52" placeholder="keterangan"   name="keterangan52" disabled="disabled" ></textarea>
