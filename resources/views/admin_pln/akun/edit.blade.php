              ...
              <div class="col-lg-7" >
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">UBAH AKUN PETUGAS</h1>
                  </div>
                  <form class="user" action="{{url('/akun/update' , $pet->id )}}" method="POST">
                    @csrf                  
                    ...
                    <!--  <select class="custom-select form-control"  style="height: calc(1.5em + .75rem + 18px); border-radius: 10rem;    font-size: .8rem; " required  name="tim">
                     ...
                     <input type="text" required class="form-control form-control-user"name="name" id="exampleInputEmail" placeholder="Nama Petugas" value=" {{  $pet->name }}">
                  </div>
                  <div class="form-group">
                    <input type="text" required class="form-control form-control-user"name="username" id="exampleInputEmail" placeholder="Username" value=" {{  $pet->username }}">
                  </div>
                  <div class="form-group">
                    <input type="text" required class="form-control form-control-user"name="password" id="exampleInputEmail" placeholder="Password" value=" ">
                  </div>
                  <hr>
