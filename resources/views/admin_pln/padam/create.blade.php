            ...
            <div class="col-lg-7" >
              <div class="p-5">
                <div class="text-center">
                  <h1 class="h4 text-gray-900 mb-4">TAMBAH JADWAL PEMADAMAN</h1>
                </div>
                <form class="user" action="{{url('/padam/store' )}}" method="POST">
                @csrf  
                  ...
                  <div class="form-group">
                    <input type="date" required class="form-control form-control-user"name="jadwal_padam" id="exampleInputEmail" placeholder="Tanggal Pemadaman" min="<?php echo date('Y-m-d'); ?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text required" class="form-control form-control-user"name="deskripsi_pekerjaan" id="exampleInputEmail" placeholder="Pekerjaan">
                </div>
                <hr>
