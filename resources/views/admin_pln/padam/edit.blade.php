            ...
            <div class="col-lg-7" >
              <div class="p-5">
                <div class="text-center">
                  <h1 class="h4 text-gray-900 mb-4">UBAH JADWAL PEMADAMAN</h1>
                </div>
                <form class="user" action="{{url('/padam/update', $pemadaman_admin->id )}}" method="POST">
                @csrf       
                  <div class="form-group">
                  <input type="text required" class="form-control form-control-user"name="nomor_pk" id="exampleInputEmail" value="{{$pemadaman_admin->nomor_pk}}" placeholder="Nomor Perintah Kerja">
                </div>             
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4 mb-3 mb-sm-0">
                      <input type="time" class="form-control form-control-user"  value="{{$pemadaman_admin->awal_padam}}" name="awal_padam" id="exampleFirstName" placeholder="Awal Padam">
                    </div>
                    <div class="col-sm-2" style="margin-top: 13px;color: #000">
                      Akhir :
                    </div>
                    <div class="col-sm-4">
                      <input type="time" class="form-control form-control-user" value="{{$pemadaman_admin->akhir_padam}}" name="akhir_padam" id="exampleLastName" placeholder="Akhir Padam" >
                    </div>
                  </div>
                  <div class="form-group">
                    <input type="date" class="form-control form-control-user" value="{{$pemadaman_admin->jadwal_padam}}" name="jadwal_padam" id="exampleInputEmail" placeholder="Tanggal Pemadaman" min="<?php echo date('Y-m-d'); ?>">
                  </div>
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" value="{{$pemadaman_admin->deskripsi_pekerjaan}}" name="deskripsi_pekerjaan" id="exampleInputEmail" placeholder="Pekerjaan">
                </div>
                <hr>
